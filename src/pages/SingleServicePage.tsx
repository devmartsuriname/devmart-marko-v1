        ...
        <div className="banner-layout-wrapper">
          <div className="banner-layout">
            <div className="d-flex flex-column text-center align-items-center gspace-2">
              <h2 className="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">Custom Web Applications</h2>
                ...
                <div className="">
                  ...
                  <div className="single-service-title-wrapper">
                    <div className="single-service-title">
                      ...
                      <h3 className="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">Build Powerful Applications with Modern Web Development</h3>
                      <p>Create custom, scalable web applications using modern tech stacks like React and Supabase. Deliver exceptional user experiences and transform how your organization operates.</p>
                    </div>
                  </div>
                </div>
                <div className="single-service-spacer"></div>
            ...
            <div className="row row-cols-xl-2 row-cols-1 grid-spacer-5">
              <div className="col col-xl-8">
                <div className="d-flex flex-column gspace-2">
                  <h4>Overview</h4>
                  <p>
                    At Devmart, we help organizations grow through custom-tailored web applications that solve real business problems. From concept to deployment, we build scalable solutions using React, Supabase, and modern development practices. Whether you're launching a new digital service or modernizing an existing system, our experts turn your vision into reality.
                  </p>
                  ...
                  <div className="card service-included">
                    ...
                    <p>Our comprehensive web development service covers everything you need to launch and maintain a successful digital platform.</p>
                  ...
                  <p>We combine technical excellence with a deep understanding of your business needs, delivering solutions that are both powerful and user-friendly.</p>
                ...
                <div className="d-flex flex-column flex-md-row flex-xl-column justify-content-between gspace-5">
                  <div className="card service-recent">
                    ...
                    <ul className="single-service-list">
                      <li><Link to="/services/social-media">Custom Web Applications</Link></li>
                      <li><Link to="/services/content">Government Portals</Link></li>
                      <li><Link to="/services/ppc">Enterprise Systems</Link></li>
                      <li><Link to="/services/email">AI-Powered Tools</Link></li>
                      <li><Link to="/services/branding">UX/UI Design</Link></li>
                      <li><Link to="/services/web-development">Maintenance & Support</Link></li>
                    </ul>
                  </div>
                  <div className="cta-service-banner">
                    ...
                    <p>
                      Elevate your digital infrastructure with cutting-edge web development and modern tech solutions. Let's build something exceptional together!
                    </p>
                    ...
                    <div className="swiper-slide">
                      <div className="card card-testimonial">
                        ...
                        <p className="testimonial-description">
                          "Devmart completely transformed our digital infrastructure! Their development expertise helped us modernize operations and improve service delivery significantly."
                        </p>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="card card-testimonial">
                        ...
                        <p className="testimonial-description">
                          "We've worked with many agencies before, but Devmart stands out. Their technical expertise and commitment to quality gave us a competitive advantage."
                        </p>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="card card-testimonial">
                        ...
                        <p className="testimonial-description">
                          "From concept to deployment, Devmart delivered exceptional results. Our platform now handles complex operations smoothly and our users love it!"
                        </p>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="card card-testimonial">
                        ...
                        <p className="testimonial-description">
                          "Highly professional and results-oriented. Devmart's expertise in enterprise systems helped us build a reliable digital foundation for growth."
                        </p>
                      </div>
                    </div>
                    <div className="swiper-slide">
            ...
            <div className="newsletter-layout">
              ...
              <div className="d-flex flex-column gspace-5 position-relative z-2">
                <div className="d-flex flex-column gspace-2 animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                  ...
                  <p>Get exclusive tech insights, development tips, and innovation updates delivered straight to your inbox. Subscribe now!</p>
                </div>
                ...
                <div className="accordion" id="faqAccordion1">
                  <div className="accordion-item">
                    ...
                    <div id="faq1" className="accordion-collapse collapse show" data-bs-parent="#faqAccordion1">
                      <div className="accordion-body">
                        ...
                        <p>We specialize in web development, including custom applications, government portals, enterprise systems, AI-powered tools, and ongoing maintenance and support.</p>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    <div id="faq2" className="accordion-collapse collapse" data-bs-parent="#faqAccordion1">
                      <div className="accordion-body">
                        <div className="accordion-spacer"></div>
                        <p>While initial setup varies, most web applications show progress within 2-3 months, with full deployment typically completed in 3-6 months depending on complexity.</p>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                    ...
                    <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#faqAccordion1">
                      <div className="accordion-body">
                        <div className="accordion-spacer"></div>
                        <p>Yes! We work with government agencies, enterprises, SMEs, and startups across various sectors in Suriname and beyond.</p>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="faq5" className="accordion-collapse collapse" data-bs-parent="#faqAccordion1">
                      <div className="accordion-body">
                        <div className="accordion-spacer"></div>
                        <p>During our initial consultation, we'll assess your requirements and recommend the best technical approach based on your goals and constraints.</p>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item">
