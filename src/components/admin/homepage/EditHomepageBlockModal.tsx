...
import { updateHomepageBlock, HomepageBlock } from "@/integrations/supabase/queries/homepageBlocks";
import { toast } from "sonner";

interface EditHomepageBlockModalProps {
  open: boolean;
...
export default function EditHomepageBlockModal({ open, block, onClose, onSuccess }: EditHomepageBlockModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.success("Homepage block updated successfully");
      onSuccess();
    }
